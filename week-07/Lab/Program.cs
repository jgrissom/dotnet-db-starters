// KDXR 88.1 "The Owl" — the overnight shift, night six.
//
// Nothing in here is yours to change tonight. The desk is exactly the one
// you finished last week — the update that came through overnight touched
// four of the OTHER files, and every one of tonight's tasks happens there
// and in Lab.Tests.
//
// You DO have to run it after every task, because this is where the fixes
// show up: the hour, the switchboard, and what goes out over the air.
//
// Run it with:   dotnet run --project week-07/Lab
//
